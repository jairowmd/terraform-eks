...
| [aws_iam_role_policy_attachment.eks_cluster_role-attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_tags"></a> [tags](#input\_tags) | Tags to be added to AWS resouces (Name tag) | `map` | n/a | yes |
